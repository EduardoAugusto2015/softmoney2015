 ...
 * @author Crawlers
 */
public class Lembrete extends javax.swing.JDialog {
    ...
    public Lembrete() {
        ...
        this.setTitle("SoftMoney - Novo Lembrete");
    }

    private Lembrete(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Novo Lembrete", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
    ...
    private void descricaotextActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    private void datatextFocusLost(java.awt.event.FocusEvent evt) {                                   

    }                                  

    private void datatextActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if(descricaotext.getText().isEmpty() && valortext.getText().isEmpty() && datatext.getText().equals("  /  /    ")){
            ...
            if(!m.find()){
                ...
                if(!data.find()){
                    ...
                    Cadastros cadastroLembrete = new Cadastros();
                    cadastroLembrete.cadastraLembrete(descricao, valorFinal, periodo, categoria);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Lembrete dialog = new Lembrete(new javax.swing.JFrame(), true);
